...
namespace Book_Storee.Forms.ChasierForm
{
    ...
    public partial class formCashier : Form
    {
            ...
            try
            {
                ...
                else
                {
                    ...
                    if( dr.HasRows) {
                        ...
                        formPos.ProductDetails(dr["bookCode"].ToString(), dr["price"].ToString(), lbl_transactionNo.Text, lblUsername.Text);
                        dr.Close();
                        cn.Close() ;
                        formPos.ShowDialog();
                    }
        ...
        private void button2_Click(object sender, EventArgs e)
        {
            canClose = true;
            this.Dispose();
            FormLogin2 form = new FormLogin2();
            form.ShowDialog();
        ...
        private void btn_search_Click(object sender, EventArgs e)
        {
            ...
            FormSearchProduct formSearchProduct = new FormSearchProduct(this);
            formSearchProduct.labelTransno.Text = lbl_transactionNo.Text;
